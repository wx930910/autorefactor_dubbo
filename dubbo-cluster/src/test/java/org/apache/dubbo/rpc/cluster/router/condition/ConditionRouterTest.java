...
public class ConditionRouterTest {
	...
	public void testRoute_matchFilter() {
		...
		Invoker<String> invoker1 = MockInvoker
				.mockInvoker1(URL.valueOf("dubbo://10.20.3.3:20880/com.foo.BarService?serialization=fastjson"));
		Invoker<String> invoker2 = MockInvoker
				.mockInvoker1(URL.valueOf("dubbo://" + LOCAL_HOST + ":20880/com.foo.BarService"));
		...
		Router router1 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host = 10.20.3.3").addParameter(FORCE_KEY,
						String.valueOf(true)));
		Router router2 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host = 10.20.3.* & host != 10.20.3.3")
						.addParameter(FORCE_KEY, String.valueOf(true)));
		Router router3 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host = 10.20.3.3  & host != 10.20.3.3")
						.addParameter(FORCE_KEY, String.valueOf(true)));
		Router router4 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host = 10.20.3.2,10.20.3.3,10.20.3.4")
						.addParameter(FORCE_KEY, String.valueOf(true)));
		Router router5 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host != 10.20.3.3").addParameter(FORCE_KEY,
						String.valueOf(true)));
		Router router6 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " serialization = fastjson")
						.addParameter(FORCE_KEY, String.valueOf(true)));

		List<Invoker<String>> filteredInvokers1 = router1.route(invokers,
				URL.valueOf("consumer://" + LOCAL_HOST + "/com.foo.BarService"), new RpcInvocation());
	...
	public void testRoute_methodRoute() {
		...
		matchWhen = ((ConditionRouter) router)
		...
		matchWhen = ((ConditionRouter) router2)
				.matchWhen(URL.valueOf("consumer://1.1.1.1/com.foo.BarService?methods=getFoo"), invocation);
		Assertions.assertFalse(matchWhen);

		Router router3 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("methods=getFoo & host=1.1.1.1 => host = 1.2.3.4"));
		matchWhen = ((ConditionRouter) router3)
				.matchWhen(URL.valueOf("consumer://1.1.1.1/com.foo.BarService?methods=getFoo"), invocation);
		Assertions.assertTrue(matchWhen);
		...
		Router router4 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " & methods = getFoo => " + " host = 10.20.3.3")
						.addParameter(FORCE_KEY, String.valueOf(true)));
		...
		Router router5 = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " & methods = unvalidmethod => " + " host = 10.20.3.3")
						.addParameter(FORCE_KEY, String.valueOf(true)));
	...
	public void testRoute_ReturnFalse() {
		...
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		invokers.add(MockInvoker.mockInvoker2());
		invokers.add(MockInvoker.mockInvoker2());
		invokers.add(MockInvoker.mockInvoker2());
	...
	public void testRoute_ReturnAll() {
		Router router = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host = " + LOCAL_HOST));
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		invokers.add(MockInvoker.mockInvoker1(URL.valueOf("dubbo://" + LOCAL_HOST + ":20880/com.foo.BarService")));
		invokers.add(MockInvoker.mockInvoker1(URL.valueOf("dubbo://" + LOCAL_HOST + ":20880/com.foo.BarService")));
		invokers.add(MockInvoker.mockInvoker1(URL.valueOf("dubbo://" + LOCAL_HOST + ":20880/com.foo.BarService")));
		List<Invoker<String>> filteredInvokers = router.route(invokers,
				URL.valueOf("consumer://" + LOCAL_HOST + "/com.foo.BarService"), new RpcInvocation());
	...
	public void testRoute_Placeholder() {
		Router router = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host = $host"));
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		Invoker<String> invoker1 = MockInvoker.mockInvoker1(URL.valueOf("dubbo://10.20.3.3:20880/com.foo.BarService"));
		Invoker<String> invoker2 = MockInvoker
				.mockInvoker1(URL.valueOf("dubbo://" + LOCAL_HOST + ":20880/com.foo.BarService"));
	...
	public void testRoute_NoForce() {
		Router router = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host = 1.2.3.4"));
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		Invoker<String> invoker1 = MockInvoker.mockInvoker1(URL.valueOf("dubbo://10.20.3.3:20880/com.foo.BarService"));
		Invoker<String> invoker2 = MockInvoker
				.mockInvoker1(URL.valueOf("dubbo://" + LOCAL_HOST + ":20880/com.foo.BarService"));
	...
	public void testRoute_Force() {
		Router router = new ConditionRouterFactory()
				.getRouter(getRouteUrl("host = " + LOCAL_HOST + " => " + " host = 1.2.3.4").addParameter(FORCE_KEY,
						String.valueOf(true)));
		List<Invoker<String>> invokers = new ArrayList<Invoker<String>>();
		Invoker<String> invoker1 = MockInvoker.mockInvoker1(URL.valueOf("dubbo://10.20.3.3:20880/com.foo.BarService"));
		Invoker<String> invoker2 = MockInvoker
