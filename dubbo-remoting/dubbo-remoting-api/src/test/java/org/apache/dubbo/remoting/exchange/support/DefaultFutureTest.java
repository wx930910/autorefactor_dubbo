...
public class DefaultFutureTest {
	...
	/**
	 * for example, it will print like this: before a future is create , time is :
	 * 2018-06-21 15:06:17 after a future is timeout , time is : 2018-06-21 15:06:22
	 * <p>
	 * The exception info print like: Sending request timeout in client-side by scan
	 * timer. start time: 2018-06-21 15:13:02.215, end time: 2018-06-21
	 * 15:13:07.231...
	 */
	@Test
	@Disabled
	...
	/**
	 * for example, it will print like this: before a future is create , time is :
	 * 2018-06-21 15:11:31 after a future is timeout , time is : 2018-06-21 15:11:36
	 * <p>
	 * The exception info print like: Waiting server-side response timeout by scan
	 * timer. start time: 2018-06-21 15:12:38.337, end time: 2018-06-21
	 * 15:12:43.354...
	 */
	@Test
	@Disabled
	public void timeoutSend() throws Exception {
		...
		System.out.println("before a future is create , time is : " + LocalDateTime.now().format(formatter));
		// timeout after 5 seconds.
		Channel channel = MockedChannel.mockChannel1();
