...
public class NettyClientTest {
	...
	public static void setUp() throws Exception {
		server = Exchangers.bind(URL.valueOf("exchange://localhost:" + port + "?server=netty3"),
	...
	public static void main(String[] args) throws RemotingException, InterruptedException {
		ExchangeChannel client = Exchangers
				.connect(URL.valueOf("exchange://10.20.153.10:20880?client=netty3&heartbeat=1000"));
	...
	public void testServerClose() throws Exception {
		for (int i = 0; i < 100; i++) {
			RemotingServer aServer = Exchangers.bind(
					URL.valueOf("exchange://localhost:" + NetUtils.getAvailablePort(6000) + "?server=netty3"),
					TelnetServerHandler.mockReplier1());
			aServer.close();
		}
	}
