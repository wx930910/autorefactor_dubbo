...
public class AbstractReferenceConfigTest {
	...
	static public AbstractReferenceConfig mockAbstractReferenceConfig1() {
		AbstractReferenceConfig mockInstance = Mockito.spy(AbstractReferenceConfig.class);
		try {
	...
	public void testCheck() throws Exception {
		AbstractReferenceConfig referenceConfig = AbstractReferenceConfigTest.mockAbstractReferenceConfig1();
	...
	public void testRouter() throws Exception {
		...
		List<RouterFactory> routerFactories = ExtensionLoader.getExtensionLoader(RouterFactory.class)
				.getActivateExtension(url, ROUTER_KEY);
		assertThat(routerFactories.stream()
				.anyMatch(routerFactory -> routerFactory.getClass().equals(ConditionRouterFactory.class)), is(true));
		...
		assertThat(routerFactories.stream()
				.allMatch(routerFactory -> !routerFactory.getClass().equals(TagRouterFactory.class)
						&& !routerFactory.getClass().equals(AppRouterFactory.class)),
				is(true));
	}
	...
	public void testGenericOverride() {
		...
		AbstractReferenceConfig referenceConfig1 = AbstractReferenceConfigTest.mockAbstractReferenceConfig1();
		...
		AbstractReferenceConfig referenceConfig2 = AbstractReferenceConfigTest.mockAbstractReferenceConfig1();
