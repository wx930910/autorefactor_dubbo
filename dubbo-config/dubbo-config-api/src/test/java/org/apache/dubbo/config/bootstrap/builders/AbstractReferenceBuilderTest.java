...
class AbstractReferenceBuilderTest {
	...
	static private AbstractReferenceConfig mockAbstractReferenceConfig1() {
	...
	private static class ReferenceBuilder extends AbstractReferenceBuilder<AbstractReferenceConfig, ReferenceBuilder> {
		...
		public AbstractReferenceConfig build() {
			AbstractReferenceConfig parameterConfig = AbstractReferenceBuilderTest.mockAbstractReferenceConfig1();
